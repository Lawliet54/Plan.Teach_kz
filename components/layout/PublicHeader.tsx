  ...
  return <header className="sticky top-0 z-30 border-b border-[var(--border)] bg-white/92 backdrop-blur-xl">
    <div className="compact-container flex h-14 items-center justify-between gap-3">
      <Link href="/" className="flex items-center gap-2.5">
        ...
        <span><span className="block text-sm font-black tracking-[-.02em] text-[var(--text)]">Plan.Teach_kz</span><span className="block text-[9px] font-black uppercase tracking-[.14em] text-[var(--text-muted)]">AI Physics Lab</span></span>
      </Link>
